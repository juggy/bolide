...
module Bundler
  LOCKED_BY    = '0.9.7'
  FINGERPRINT  = "5d5a9e6cfe0047ee23b9e07e54fcaf0455d5fd78"
  AUTOREQUIRES = {:default=>[["validatable", false], ["daemons", false], ["eventmachine", false], ["carrot", false], ["amqp", false], ["memcachedb-client", false], ["uuid", false], ["system_timer", false]]}
  SPECS        = [
        ...
        {:load_paths=>["/opt/local/lib/ruby/gems/1.8/gems/amqp-0.6.7/lib"], :loaded_from=>"/opt/local/lib/ruby/gems/1.8/specifications/amqp-0.6.7.gemspec"},
