# unicorn_rails -c /data/github/current/config/server/app/ws.jguimont.com.rb -E production -D
...
before_fork do |server, worker|
  ...
  old_pid = "/u/apps/bolide/current/stream_app/tmp/pids/live.pid.oldbin"
